...
import pandas as pd 
from functions import get_micro_cap_stocks, get_small_cap_stocks, gainers, new_52_week_high, finviz_gainers, finviz_loosers, new_52_week_low
...
def get_gainers():
    ...
    return render_template('gainers.html', table_1=table_html_1, table_2 = table_html_2, table_3 = table_html_3, table_4 = table_html_4, date=date)
